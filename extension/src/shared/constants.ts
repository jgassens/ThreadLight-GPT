...
export const THREADLIGHT_DIAGNOSTIC_EVENT = "threadlight-diagnostic";
export const THREADLIGHT_DIAGNOSTIC_REPLAY_REQUEST_EVENT = "threadlight-diagnostic-replay-request";
...
export const THREADLIGHT_GET_DIAGNOSTICS_MESSAGE = "threadlight-get-diagnostics";
export const THREADLIGHT_CLEAR_DIAGNOSTICS_MESSAGE = "threadlight-clear-diagnostics";
export const THREADLIGHT_TAB_GET_DIAGNOSTICS_MESSAGE = "threadlight-tab-get-diagnostics";
export const THREADLIGHT_TAB_CLEAR_DIAGNOSTICS_MESSAGE = "threadlight-tab-clear-diagnostics";
